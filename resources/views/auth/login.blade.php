    ...
    <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
            <div class="flex-row text-center mx-auto">
                <img
                    src="{{ asset('assets/img/pages/logo.png') }}"
                    alt="Auth Cover Bg color"
                    width="520"
                    class="img-fluid authentication-cover-img"
                    data-app-light-img="pages/logo.png"
                    data-app-dark-img="pages/login-dark.png"
                />
                <div class="mx-auto">
                    <h3>Analyze Your ESG!</h3>
                    <p>
                        The Smart Way To Track And Manage Your ESG Initiatives <br />
...
{{--                          <img src="{{ asset('assets/img/logo-full.png') }}" alt="" class="img-fluid" width="200" height="150">--}}
{{--                        </span>--}}
