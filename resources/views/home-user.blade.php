        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 mb-4">
                <div class="card h-100">
                    ...
                    ><i class="bx bx-notification fs-4"></i
                        ></span>
                        </div>
                        <span class="d-block text-nowrap">NO. URUT</span>
                        <h2 class="mb-0">{{ $registrasi->no_urut??'' }}</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 mb-4">
                <div class="card h-100">
                    ...
                    ><i class="bx bx-calculator fs-4"></i
                        ...
                        <span class="d-block text-nowrap">QUICK COUNT</span>
            ...
            <div class="col-md-6 col-lg-3 mb-4">
                <div class="card h-100">
                    ...
                    ><i class="bx bx-user fs-4"></i
                        ...
                        <span class="d-block text-nowrap">TIM SUKSES</span>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <li class="d-flex align-items-center mb-4">
                                <i class="bx bx-user"></i><span class="fw-semibold mx-2">Tim Sukses:</span>
                                <span>{{ auth()->user()->teams->count() }} Orang</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="d-flex align-items-start">
                                            <div class="avatar me-3">
                                                <img src="{{ $team->getFirstMediaUrl("avatars")??asset('assets/img/avatars/user.png') }}" alt="Avatar" class="rounded-circle" />
                                            </div>
                                            <div class="me-2">
                                                <h6 class="mb-0">{{ $team->nama }}</h6>
                                                <small class="text-muted">{{ $survey->where('user_id',$team->id)->count() }} Survey</small>
                                            </div>
                                        </div>
                                    </div>
                                </li>
